...
static void DuplicateInputs(benchmark::Bench& bench)
{
    ...
    coinbaseTx.vout[0].nValue = GetProofOfWorkReward(GetLastBlockIndex(testing_setup->m_node.chainman->ActiveChain().Tip(), false)->nBits, coinbaseTx.nTime, blockHeight, fees);
