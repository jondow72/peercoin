 ...
 * */
// validation.h COINS_BURNED = 720000 * COIN; // Notes: https://bitcointalk.org/index.php?topic=735170.msg9475622#msg9475622
static constexpr CAmount MAX_MONEY = 25720000 * COIN;  // NOte: the amount of COINS_BURNED is unspendable
