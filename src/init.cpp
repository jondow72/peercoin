...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-corsdomain=<domain>", "Send access control allow origin http header with rest replies (default: not sent)", ArgsManager::ALLOW_ANY, OptionsCategory::RPC);
