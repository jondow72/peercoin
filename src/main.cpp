...
bool CBlock::CheckBlock(CValidationState &state, CBlockIndex* pindex, bool fCheckPOW, bool fCheckMerkleRoot) const
{
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0x70070d9e41ffd85685f8017fa8620fb5572ed8443822d799015d01d39e7fd4af"));
        block.print();
